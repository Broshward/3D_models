...
count=264
#obj = 'cylinder(1,d=1)'
text='2x2=%d '#'FUAZRKXPHNIGJCYSTBEMLWOD'
obj = 'rotate(90) translate([0,-1,0]) text("%s", size = %f, font = "Times New Roman:style=Bold", valign = "center")'
...
#    l_r = asin((dr/2)/step)*2*180/pi
    ...
    polars.append([r,a])
    if r>50: 
        obj1='linear_extrude(1) '+obj %((text %(i%10))[i%len(text)-1],r/4)
    else:
